...
The resulting matrix will now not be totally unimodular. Consider vertices h2, h3 and g2 from our earlier example. The $3\times 3$ matrix formed by this subgraph and the constraint row has determinant -2:
