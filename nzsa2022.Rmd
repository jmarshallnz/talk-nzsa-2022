...
And there's no evidence this will be optimal.
...
This also holds for genes - the most complete gene may not be in the set $G_o$.
...
There are three well studied problems finding different maximum cliques:

1. The clique with the largest number of vertices.

2. The clique with the largest number of vertices such that the number of vertices from both groups is the same.

3. The clique with the most edges.
...
Each point on our chart corresponds to the largest clique for a given number of vertices in the first group.
